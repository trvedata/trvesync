...
module CRDT
  ...
  class Peer
    ...
    Message = Struct.new(:origin_peer_id, :msg_count, :offset, :operations)
    ...
    def initialize(peer_id=nil, options={})
      ...
      @logical_ts = 0
      @channel_id = options[:channel_id] || bin_to_hex(OpenSSL::Random.random_bytes(16)) # TODO should be generated by server?
      @channel_offset = -1
    ...
    def make_message
      ...
      message = Message.new(peer_id, peer_matrix.increment_sent_messages, nil, @send_buf)
      @send_buf = []
      message
    end
